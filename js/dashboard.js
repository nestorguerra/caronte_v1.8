...
window.switchTab = function (tabId) {
    ...
    if (!dashboardInstance) {
        console.error('Dashboard instance not found! Attempting auto-recovery...');
        try {
            dashboardInstance = new Dashboard();
            console.log('Recovery successful.');
        } catch (e) {
            console.error('Recovery failed:', e);
            // If recovery fails, session is likely dead. Redirect to login.
    ...
    dashboardInstance.switchTab(tabId);
